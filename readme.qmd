...
In 2022, the US Census Bureau released updated urbanized area (UZA) boundaries. The `.qmd` in this repo outlines the process of intersecting the [MassGIS Data: Trains](https://www.mass.gov/info-details/massgis-data-trains) dataset over these geographies to find the length of commuter rail track in each urbanized area.
