...
saveRDS(gtfs_summ22_shp_line,
        "../data/processed/gtfs_summ22_shp_line.rds")
```
...
```{r}
# Read in trains
trains_pass <- readRDS("../data/processed/gtfs_summ22_shp_line.rds")
...
write_csv(trains_pass_UZA10_summ |> arrange(desc(len_tot_mi)), "../output/trains_pass_gtfs_UZA10_summ.csv")

write_csv(trains_pass_UZA20_summ |> arrange(desc(len_tot_mi)), "../output/trains_pass_gtfs_UZA20_summ.csv")
```
